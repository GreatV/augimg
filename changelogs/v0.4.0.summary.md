...
[overview](https://augimg.readthedocs.io/en/latest/source/overview_of_augmenters.html)
...
<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/addtobrightness.jpg?raw=true" width="800" />
...
<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/cartoon.jpg?raw=true" width="800" />
...
<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/changecolortemperature.jpg?raw=true" width="800" />
...
<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/cutout.jpg?raw=true" width="800" />
...
<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/dropout2d.jpg?raw=true" width="800" />
...
<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/jigsaw.jpg?raw=true" width="800" />
...
<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/meanshiftblur.jpg?raw=true" width="800" />
...
<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/posterize.jpg?raw=true" width="800" />
...
<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/solarize.jpg?raw=true" width="800" />
...
<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/rain.jpg?raw=true" width="800" />
...
<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/randaugment.jpg?raw=true" width="800" />
...
<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/withpolarwarping.jpg?raw=true" width="800" />
...
<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/imgcorruptlike.jpg?raw=true" width="800" />
...
<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/pillike.jpg?raw=true" width="800" />
...
<p float="left">
  <img src="https://github.com/greatv/augimg-doc/blob/master/images/annotated/cityscapes5.png" width="380" />
  <img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/cityscapes5-car-lights-changed.jpg?raw=true" width="380" />
</p>
...
<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/cityscapes5-train-color.jpg?raw=true" width="380" />
...
<p float="left">
  <img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/cityscapes5-street-gaussian-noise.jpg?raw=true" width="380" />
  <img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/cityscapes5-street-embossed.jpg?raw=true" width="380" />
</p>
...
<p float="left">
  <img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/cityscapes5-regular-grid-dropout.jpg?raw=true" width="380" />
  <img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/cityscapes5-checkerboard-dropout.jpg?raw=true" width="380" />
</p>

This example shows `BlendAlphaSomeColors(RemoveSaturation(1.0))`, applied
to a more colorful image:

<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/blendalphasomecolors_removesaturation.jpg?raw=true" width="800" />
...
<img src="https://github.com/greatv/augimg-doc/blob/master/images/changelogs/0.4.0/savedebugimageeverynbatches.jpg?raw=true" width="512" />
...
## Reworked Augmentation Methods [#451](https://github.com/greatv/augimg/pull/451) [#566](https://github.com/greatv/augimg/pull/566)
...
* Changed:
  ...
  * Changed `augimg.augmentables.BoundingBoxesOnImage.from_xyxy_array()`
...
## Reworked Quantization [#467](https://github.com/greatv/augimg/pull/467)
...
* Deprecated:
  ...
  * Renamed `augimg.augmenters.color.quantize_colors_kmeans(image, n_colors)`
    to `augimg.augmenters.color.quantize_kmeans(arr, nb_clusters)`. The old
...
## Improved Invert [#469](https://github.com/greatv/augimg/pull/469)
...
## All Augmenters are now Pickle-able [#493](https://github.com/greatv/augimg/pull/493) [#575](https://github.com/greatv/augimg/pull/575)
...
## Extended Cropping and Padding Augmenters [#459](https://github.com/greatv/augimg/pull/459)
...
## More Choices for Image Blending [#462](https://github.com/greatv/augimg/pull/462) [#556](https://github.com/greatv/augimg/pull/556)
...
## Unwrapped Bounding Box Augmentation [#446](https://github.com/greatv/augimg/pull/446)
...
* Added method `augimg.testutils.shift_cbaoi()`.
...
## Unwrapped Line String Augmentation [#450](https://github.com/greatv/augimg/pull/450)
...
## Added fit_output to PerspectiveTransform [#452](https://github.com/greatv/augimg/pull/452) [#456](https://github.com/greatv/augimg/pull/456)
...
# Added `ChangeColorTemperature` Augmenter [#454](https://github.com/greatv/augimg/pull/454)
...
## Added Brightness Augmenters [#455](https://github.com/greatv/augimg/pull/455)
...
## Added More Dropout Augmenters [#458](https://github.com/greatv/augimg/pull/458)
...
## Added `RemoveSaturation` [#462](https://github.com/greatv/augimg/pull/462)

* Added `RemoveSaturation`, a shortcut for `MultiplySaturation((0.0, 1.0))`
  with outputs similar to `Grayscale((0.0, 1.0))`.


## Added `Cartoon` Augmenter [#463](https://github.com/greatv/augimg/pull/463)
...
## Added `MeanShiftBlur` Augmenter [#466](https://github.com/greatv/augimg/pull/466)
...
## Added `DeterministicList` Parameter [#475](https://github.com/greatv/augimg/pull/475)
...
## Added `Jigsaw` Augmenter [#476](https://github.com/greatv/augimg/pull/476) [#577](https://github.com/greatv/augimg/pull/577)
...
## Added Wrappers around Package `PIL` [#479](https://github.com/greatv/augimg/pull/479) [#480](https://github.com/greatv/augimg/pull/480) [#538](https://github.com/greatv/augimg/pull/538)
...
## Added `Identity` [#481](https://github.com/greatv/augimg/pull/481)
...
## Added Shearing on the Y-Axis to `Affine` [#482](https://github.com/greatv/augimg/pull/482)
...
## Added Wrappers around `Affine` [#484](https://github.com/greatv/augimg/pull/484)
...
## Added More Methods to Remove Out-of-Image Augmentables [#487](https://github.com/greatv/augimg/pull/487)
...
## Added Bounding Box to Polygon Conversion [#489](https://github.com/greatv/augimg/pull/489)
...
## Added Polygon Subdivision [#489](https://github.com/greatv/augimg/pull/489)
...
## Added `WithPolarWarping` Augmenter [#489](https://github.com/greatv/augimg/pull/489)
...
## Added Convenient Access Methods to Coordinate-Based Augmentables [#495](https://github.com/greatv/augimg/pull/495) [#541](https://github.com/greatv/augimg/pull/541)
...
## Added `SaveDebugImageEveryNBatches` Augmenter [#502](https://github.com/greatv/augimg/pull/502)
...
## Added Multi-Channel cvals in `pad()` [#502](https://github.com/greatv/augimg/pull/502)

Improved `augimg.augmenters.size.pad()` to support multi-channel values
for the `cval` parameter (e.g. RGB colors).


## Added Wrappers around Package `imagecorruptions` [#530](https://github.com/greatv/augimg/pull/530)
...
## Added `Cutout` Augmenter [#531](https://github.com/greatv/augimg/pull/531) [#570](https://github.com/greatv/augimg/pull/570)
...
## Added in-place Methods for Coordinate-based Augmentables [#532](https://github.com/greatv/augimg/pull/532)
...
## Added Standardized LUT Methods [#542](https://github.com/greatv/augimg/pull/542)
...
## Added Drawing of Bounding Box Labels [#545](https://github.com/greatv/augimg/pull/545)
...
## Added Index-based Access to Coordinate-based `*OnImage` Instances [#547](https://github.com/greatv/augimg/pull/547)
...
## Added `Rain` and `RainLayer` Augmenters [#551](https://github.com/greatv/augimg/pull/551)
...
## Added `round` Parameter to `Discretize` [#553](https://github.com/greatv/augimg/pull/553)
...
## Added `RandAugment` Augmenter [#553](https://github.com/greatv/augimg/pull/553)
...
## Added and Improved Warnings for Probably-Wrong Image Inputs [#594](https://github.com/greatv/augimg/pull/594)
...
## Improved RNG Handling during Polygon Augmentation [#447](https://github.com/greatv/augimg/pull/447)
...
## Pooling Augmenters now Affect Maps [#457](https://github.com/greatv/augimg/pull/457)
...
## Affine Translation Precision [#489](https://github.com/greatv/augimg/pull/489)
...
## `Affine.get_parameters()` and `translate_px`/`translate_percent` [#508](https://github.com/greatv/augimg/pull/508)
...
## Removed Outdated "Don't Import from this Module" Messages [#539](https://github.com/greatv/augimg/pull/539)
...
## Standardized `shift()` Interfaces of Coordinate-Based Augmentables [#548](https://github.com/greatv/augimg/pull/548)
...
## Simplified Standard Parameters of Augmenters [#567](https://github.com/greatv/augimg/pull/567) [#595](https://github.com/greatv/augimg/pull/595)
...
`augimg.random.seed()` (global seeding, affects only augmenters
...
## Improved Default Values of Augmenters [#582](https://github.com/greatv/augimg/pull/582)
...
## `setup.py` Now Accepts any `opencv-*` Installation [#586](https://github.com/greatv/augimg/pull/586)
...
`augimg` will then currently request `opencv-python-headless`
...
## Unified OpenCV Input Normalization [#565](https://github.com/greatv/augimg/pull/565)
...
## Renamed In-place Methods [#444](https://github.com/greatv/augimg/pull/444)
...
## Deprecated `AffineCv2` [#540](https://github.com/greatv/augimg/pull/540)

Deprecated `augimg.augmenters.geometric.AffineCv2`.
Use `augimg.augmenters.geometric.Affine` instead. [#540](https://github.com/greatv/augimg/pull/540)
...
## Refactored According to pylint Requirements [#504](https://github.com/greatv/augimg/pull/504)
...
* Fixed `Resize` always returning an `uint8` array during image augmentation
  ...
  same shape. [#442](https://github.com/greatv/augimg/pull/442) [#443](https://github.com/greatv/augimg/pull/443)
* Fixed `Affine` coordinate-based augmentation applying wrong offset
  ...
  of around 0.5 to 1.0 pixels. [#446](https://github.com/greatv/augimg/pull/446)
* Fixed keypoint augmentation in `PiecewiseAffine` potentially being
  unaligned if a `KeypointsOnImage` instance contained no keypoints. [#446](https://github.com/greatv/augimg/pull/446)
* Fixed `augimg.validation.convert_iterable_to_string_of_types()` crashing due
  to not converting types to strings before joining them. [#446](https://github.com/greatv/augimg/pull/446)
* Fixed `augimg.validation.assert_is_iterable_of()` producing a not
  well-designed error if the input was not an iterable. [#446](https://github.com/greatv/augimg/pull/446)
...
* Fixed a typo in an image normalization error message. [#451](https://github.com/greatv/augimg/pull/451)
* Fixed a problem in `WithChannels` that could lead random sampling in child
  ...
  data. [#451](https://github.com/greatv/augimg/pull/451)
* Added aliases to `augimg.random.RNG` for some outdated numpy random number
  ...
  interacting with the provided `random_state` instances. [#486](https://github.com/greatv/augimg/pull/486) 
* Fixed `Affine` producing unaligned augmentations between images and
  ...
  map or heatmap had a different height/width than corresponding image. [#489](https://github.com/greatv/augimg/pull/489)
* Fixed a crash in `SnowflakesLayer` that could occur when using values
  close to `1.0` for `flake_size`. [#471](https://github.com/greatv/augimg/pull/471)
* Fixed `MultiplyHueAndSaturation` crashing if the RNG provided via
  `random_state` was not `None` or `augimg.random.RNG`. [#493](https://github.com/greatv/augimg/pull/493)
* Fixed `CloudLayer.draw_on_image()` producing tuples instead of arrays
  as output for `float` input images. [#540](https://github.com/greatv/augimg/pull/540)
* Fixed `Affine` parameter `translate_px` behaving like `translate_percent`
  ...
  a discrete stochastic parameter was provided. [#508](https://github.com/greatv/augimg/pull/508)
* Fixed code hanging indefinitely when using multicore augmentation
  on NixOS. [#414](https://github.com/greatv/augimg/issues/414) [#510](https://github.com/greatv/augimg/pull/510)
* Fixed a deprecation warning and potential crash in python 3.8
  related to the use of `collections` instead of `collections.abc`. [#527](https://github.com/greatv/augimg/pull/527)
* Fixed deprecated `scipy.fromfunction()` being called. [#529](https://github.com/greatv/augimg/pull/529)
* Fixed `augimg.random.normalize_generator()` crashing in numpy 1.18.
  ...
  deprecation period for the old name. [#534](https://github.com/greatv/augimg/pull/534)
* Fixed an issue that could lead to endlessly hanging programs on some OS
  ...
  OpenCV. [#535](https://github.com/greatv/augimg/pull/535)
* Fixed `augimg.random.seed()` not seeding the global `RNG` in-place
  ...
  *before* the `seed()` call as they would continue to use the old
  global RNG. [#557](https://github.com/greatv/augimg/pull/557)
* Fixed `cval` in `ElasticTransformation` resulting in new pixels in RGB images
  being filled with `(cval, 0, 0)` instead of `(cval, cval, cval)`. [#561](https://github.com/greatv/augimg/pull/561) [#562](https://github.com/greatv/augimg/pull/562)
* Fixed some augmenters in module `weather` not transferring seed values
  or random states that were provided upon creation to child augmenters. [#568](https://github.com/greatv/augimg/pull/568)
* Fixed an inaccuracy in `PerspectiveTransform` that could lead to slightly
  ...
  worsened by using `fit_output`. [#585](https://github.com/greatv/augimg/pull/585)
* Fixed `KeepSizeByResize` potentially crashing if a single numpy array
  ...
  a list of numpy arrays). [#590](https://github.com/greatv/augimg/pull/590)
