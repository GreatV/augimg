...
def handle_categorical_string_param(param, name, valid_values=None,
    ...
    raise Exception(
        ...
        "strings or StochasticParameter, got %s." % (
            name,
            " augimg.ALL," if valid_values is not None else "",
            type(param).__name__,))
...
class StochasticParameter(object):
    ...
    def copy(self):
        ...
        Returns
        -------
        augimg.parameters.StochasticParameter
            Shallow copy.
    ...
    def draw_distribution_graph(self, title=None, size=(1000, 1000), bins=100):
        ...
        size : tuple of int
            ...
            to each :func:`~augimg.parameters.StochasticParameter.draw_samples`
...
class Deterministic(StochasticParameter):
    ...
    Parameters
    ----------
    value : number or str or augimg.parameters.StochasticParameter
...
class Binomial(StochasticParameter):
    ...
    Parameters
    ----------
    p : number or tuple of number or list of number or augimg.parameters.StochasticParameter
...
class DiscreteUniform(StochasticParameter):
    ...
    Parameters
    ----------
    a : int or tuple of int or list of int or augimg.parameters.StochasticParameter
    ...
    b : int or augimg.parameters.StochasticParameter
...
class Poisson(StochasticParameter):
    ...
    Parameters
    ----------
    lam : number or tuple of number or list of number or augimg.parameters.StochasticParameter
...
class Normal(StochasticParameter):
    ...
    Parameters
    ----------
    loc : number or tuple of number or list of number or augimg.parameters.StochasticParameter
    ...
    scale : number or tuple of number or list of number or augimg.parameters.StochasticParameter
...
class TruncatedNormal(StochasticParameter):
    ...
    low : number or tuple of number or list of number or augimg.parameters.StochasticParameter
        The minimum value of the truncated normal distribution.
        Datatype behaviour is the same as for `loc`.

    high : number or tuple of number or list of number or augimg.parameters.StochasticParameter
...
class ChiSquare(StochasticParameter):
    ...
    Parameters
    ----------
    df : int or tuple of two int or list of int or augimg.parameters.StochasticParameter
...
class Weibull(StochasticParameter):
    ...
    Parameters
    ----------
    a : number or tuple of number or list of number or augimg.parameters.StochasticParameter
...
class Uniform(StochasticParameter):
    ...
    b : number or tuple of number or list of number or augimg.parameters.StochasticParameter
        Upper bound of the interval. Analogous to `a`.
...
class Beta(StochasticParameter):
    ...
    Parameters
    ----------
    alpha : number or tuple of number or list of number or augimg.parameters.StochasticParameter
    ...
    beta : number or tuple of number or list of number or augimg.parameters.StochasticParameter
...
class FromLowerResolution(StochasticParameter):
    ...
    Parameters
    ----------
    other_param : augimg.parameters.StochasticParameter
        The other parameter which is to be sampled on a coarser image.

    size_percent : None or number or iterable of number or augimg.parameters.StochasticParameter, optional
    ...
    size_px : None or number or iterable of numbers or augimg.parameters.StochasticParameter, optional
    ...
    method : str or int or augimg.parameters.StochasticParameter, optional
        ...
        the same as in :func:`~augimg.augimg.imresize_many_images`. Usually
...
class Multiply(StochasticParameter):
    ...
    Parameters
    ----------
    other_param : number or tuple of number or list of number or augimg.parameters.StochasticParameter
    ...
    val : number or tuple of number or list of number or augimg.parameters.StochasticParameter
        Multiplier to use.
...
class Add(StochasticParameter):
    ...
    val : number or tuple of two number or list of number or augimg.parameters.StochasticParameter
...
class IterativeNoiseAggregator(StochasticParameter):
    ...
    iterations : int or iterable of int or list of int or augimg.parameters.StochasticParameter, optional
    ...
    aggregation_method : augimg.ALL or {'min', 'avg', 'max'} or list of str or augimg.parameters.StochasticParameter, optional
        ...
        iterations), ``max`` (take the maximum) and ``avg`` (take the average).
            ...
            * If ``augimg.ALL``, then equivalent to the ``list``
              ``["min", "max", "avg"]``.
...
class Sigmoid(StochasticParameter):
    ...
    threshold : number or tuple of number or iterable of number or augimg.parameters.StochasticParameter, optional
    ...
    def create_for_noise(other_param, threshold=(-10, 10), activated=True):
        ...
        ----------
        other_param : augimg.parameters.StochasticParameter
            See :func:`~augimg.parameters.Sigmoid.__init__`.
...
class SimplexNoise(StochasticParameter):
    ...
    upscale_method : str or int or list of str or list of int or augimg.parameters.StochasticParameter, optional
        ...
        use. See also :func:`~augimg.augimg.imresize_many_images` for a
...
class FrequencyNoise(StochasticParameter):
    ...
    Parameters
    ----------
    exponent : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
    ...
    upscale_method : augimg.ALL or str or list of str or augimg.parameters.StochasticParameter, optional
        After generating the noise maps in low resolution environments, they
        have to be upscaled to the originally requested shape (i.e. usually
        the image size). This parameter controls the interpolation method to
        use. See also :func:`~augimg.augimg.imresize_many_images` for a
