...
It provides the :class:`~augimg.random.RNG` class, which is the primary
random number generator in ``augimg``. It also provides various utility
...
generation classes and methods behin augimg-specific classes and methods.
...
- *RandomState*: An instance of `numpy.random.RandomState`.
  ...
  :class:`numpy.random.Generator` or :class:`~augimg.random.RNG`.
- *RNG*: An instance of :class:`~augimg.random.RNG`.
...
class RNG(object):
    """
    Random number generator for augimg.
    ...
    * :func:`numpy.random.RandomState.set_state`
    ...
    In :func:`~augimg.random.RNG.choice`, the `axis` argument is not yet
    supported.
    ...
    def equals(self, other):
        ...
        assert isinstance(other, RNG), (
            ...
            "Use augimg.random.is_generator_equal_to() to compare "
    ...
    def advance_(self):
        ...
        .. note::
            ...
            changes, call :func:`~augimg.random.RNG.derive_rng_`.
    ...
    def duplicate(self, n):
        ...
        calls of :func:`~augimg.random.RNG.derive_rngs_`. These calls
    ...
    def create_fully_random(cls):
        ...
        RNG
            ...
            RNG, nor does it depend on the seeding of augimg or numpy.
...
def seed(entropy):
    """Set the seed of augimg's global RNG (in-place).
...
def set_generator_state_(generator, state):
    ...
    state : tuple or dict
        ...
        :func:`~augimg.random.get_generator_state`.
...
def advance_generator_(generator):
    ...
    .. note::
        ...
        a call of this method will not completely change the outputs of
        the next called sampling method. To achieve more drastic output
        changes, call :func:`~augimg.random.derive_generator_`.
