...
def draw_debug_image(images, heatmaps=None, segmentation_maps=None,
    ...
    **Supported dtypes**:
    ...
    heatmaps : None or list of augimg.augmentables.heatmaps.HeatmapsOnImage, optional
        Heatmaps on the provided images.

    segmentation_maps : None or list of augimg.augmentables.segmaps.SegmentationMapsOnImage, optional
        Segmentation maps on the provided images.

    keypoints : None or list of augimg.augmentables.kps.KeypointsOnImage, optional
        Keypoints on the provided images.

    bounding_boxes : None or list of augimg.augmentables.bbs.BoundingBoxesOnImage, optional
        Bounding boxes on the provided images.

    polygons : None or list of augimg.augmentables.polys.PolygonsOnImage, optional
        Polygons on the provided images.

    line_strings : None or list of augimg.augmentables.lines.LineStringsOnImage, optional
    ...
    ``UnnormalizedBatch`` to show how to mostly evade going through augimg
    classes.
...
class SaveDebugImageEveryNBatches(_SaveDebugImage):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.debug.draw_debug_image`.
