...
def fliplr(arr):
    ...
    **Supported dtypes**:
    ...
    --------
    >>> import numpy as np
    >>> import augimg.augmenters.flip as flip
...
def _fliplr_cv2(arr):
    ...
    if arr.ndim == 3 and arr.shape[-1] > 512:
        ...
        # Normalization from augimg.augimg._normalize_cv2_input_arr_().
...
class Fliplr(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.flip.fliplr`.

    Parameters
    ----------
    p : number or augimg.parameters.StochasticParameter, optional
...
class Flipud(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.flip.flipud`.
