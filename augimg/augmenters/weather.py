...
class FastSnowyLandscape(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    lightness_threshold : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
    ...
    lightness_multiplier : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
    ...
    from_colorspace : str, optional
        ...
        See :func:`~augimg.augmenters.color.ChangeColorspace.__init__`.
    ...
    **Supported dtypes**:
        ...
        * ``bool``: no
        ...
        - (2) Note that random values are usually sampled as ``int64`` or
              ...
              via :func:`~augimg.augimg.imresize_many_images` and has its own
              limited dtype support (includes however floats up to ``64bit``).

    Parameters
    ----------
    intensity_mean : number or tuple of number or list of number or augimg.parameters.StochasticParameter
    ...
    intensity_freq_exponent : number or tuple of number or list of number or augimg.parameters.StochasticParameter
        Exponent of the frequency noise used to add fine intensity to the
        mean intensity.
        Recommended to be in the interval ``[-2.5, -1.5]``.
        See :func:`~augimg.parameters.FrequencyNoise.__init__` for details.

    intensity_coarse_scale : number or tuple of number or list of number or augimg.parameters.StochasticParameter
    ...
    alpha_min : number or tuple of number or list of number or augimg.parameters.StochasticParameter
    ...
    alpha_multiplier : number or tuple of number or list of number or augimg.parameters.StochasticParameter
    ...
    alpha_size_px_max : number or tuple of number or list of number or augimg.parameters.StochasticParameter
    ...
    alpha_freq_exponent : number or tuple of number or list of number or augimg.parameters.StochasticParameter
    ...
    sparsity : number or tuple of number or list of number or augimg.parameters.StochasticParameter
    ...
    density_multiplier : number or tuple of number or list of number or augimg.parameters.StochasticParameter
...
class Clouds(meta.SomeOf):
    ...
    This is a wrapper around :class:`~augimg.augmenters.weather.CloudLayer`.
...
class SnowflakesLayer(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    density : number or tuple of number or list of number or augimg.parameters.StochasticParameter
    ...
    density_uniformity : number or tuple of number or list of number or augimg.parameters.StochasticParameter
    ...
    flake_size : number or tuple of number or list of number or augimg.parameters.StochasticParameter
    ...
    flake_size_uniformity : number or tuple of number or list of number or augimg.parameters.StochasticParameter
    ...
    angle : number or tuple of number or list of number or augimg.parameters.StochasticParameter
        ...
        See also :func:`~augimg.augmenters.blur.MotionBlur.__init__`.
    ...
    speed : number or tuple of number or list of number or augimg.parameters.StochasticParameter
    ...
    blur_sigma_fraction : number or tuple of number or list of number or augimg.parameters.StochasticParameter
...
class Snowflakes(meta.SomeOf):
    ...
    :class:`~augimg.augmenters.weather.SnowflakesLayer`. It executes 1 to 3
    layers per image.
...
class RainLayer(SnowflakesLayer):
    ...
    **Supported dtypes**:
    ...
    ----------
    density : number or tuple of number or list of number or augimg.parameters.StochasticParameter
        Same as in :class:`~augimg.augmenters.weather.SnowflakesLayer`.

    density_uniformity : number or tuple of number or list of number or augimg.parameters.StochasticParameter
        Same as in :class:`~augimg.augmenters.weather.SnowflakesLayer`.

    drop_size : number or tuple of number or list of number or augimg.parameters.StochasticParameter
        Same as `flake_size` in
        :class:`~augimg.augmenters.weather.SnowflakesLayer`.

    drop_size_uniformity : number or tuple of number or list of number or augimg.parameters.StochasticParameter
...
class Rain(meta.SomeOf):
    ...
    This is a wrapper around
    :class:`~augimg.augmenters.weather.RainLayer`. It executes 1 to 3
    layers per image.
    ...
    **Supported dtypes**:
    ...
    ----------
    drop_size : number or tuple of number or list of number or augimg.parameters.StochasticParameter
        See :class:`~augimg.augmenters.weather.RainLayer`.
