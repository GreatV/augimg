...
# TODO this is the same as in augimg.py, make DRY
# Added in 0.4.0.
...
def pad(arr, top=0, right=0, bottom=0, left=0, mode="constant", cval=0):
    ...
    Added in 0.4.0. (Previously named ``augimg.augimg.pad()``.)
...
def pad_to_aspect_ratio(arr, aspect_ratio, mode="constant", cval=0,
    ...
    See :func:`~augimg.augimg.compute_paddings_for_aspect_ratio` for an
    explanation of how the required padding amounts are distributed per
    image axis.

    Added in 0.4.0. (Previously named ``augimg.augimg.pad_to_aspect_ratio()``.)

    **Supported dtypes**:

    See :func:`~augimg.augmenters.size.pad`.
    ...
    mode : str, optional
        Padding mode to use. See :func:`~augimg.augimg.pad` for details.
...
def pad_to_multiples_of(arr, height_multiple, width_multiple, mode="constant",
    ...
    Added in 0.4.0. (Previously named ``augimg.augimg.pad_to_multiples_of()``.)
...
def compute_paddings_to_reach_aspect_ratio(arr, aspect_ratio):
    ...
    ``augimg.augimg.compute_paddings_to_reach_aspect_ratio()``.)
...
def compute_paddings_to_reach_multiples_of(arr, height_multiple,
    ...
    Added in 0.4.0. (Previously named
    ``augimg.augimg.compute_paddings_to_reach_multiples_of()``.)
...
def compute_paddings_to_reach_powers_of(arr, height_base, width_base,
    ...
    Added in 0.4.0. (Previously named
    ``augimg.augimg.compute_paddings_to_reach_exponents_of()``.)
...
class Resize(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augimg.imresize_many_images`.

    Parameters
    ----------
    size : 'keep' or int or float or tuple of int or tuple of float or list of int or list of float or augimg.parameters.StochasticParameter or dict
    ...
    interpolation : augimg.ALL or int or str or list of int or list of str or augimg.parameters.StochasticParameter, optional
        Interpolation to use.

            * If ``augimg.ALL``, then a random interpolation from ``nearest``,
...
class CropAndPad(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    if (keep_size=True):
        ...
        minimum of (
            ``augimg.augmenters.size.CropAndPad(keep_size=False)``,
            :func:`~augimg.augimg.imresize_many_images`
        )

    Parameters
    ----------
    px : None or int or augimg.parameters.StochasticParameter or tuple, optional
    ...
    percent : None or number or augimg.parameters.StochasticParameter or tuple, optional
        The number of pixels to crop (negative values) or pad (positive values)
    ...
    pad_mode : augimg.ALL or str or list of str or augimg.parameters.StochasticParameter, optional
        ...
        by ``pad_cval`` when necessary. See :func:`~augimg.augimg.pad` for
        more details.

            * If ``augimg.ALL``, then a random mode from all available modes
    ...
    pad_cval : number or tuple of number list of number or augimg.parameters.StochasticParameter, optional
        The constant value to use if the pad mode is ``constant`` or the end
        value to use if the mode is ``linear_ramp``.
        See :func:`~augimg.augimg.pad` for more details.
...
class Pad(CropAndPad):
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.size.CropAndPad`.
    ...
    percent : None or int or float or augimg.parameters.StochasticParameter or tuple, optional
...
class PadToFixedSize(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    pad_mode : augimg.ALL or str or list of str or augimg.parameters.StochasticParameter, optional
        See :func:`~augimg.augmenters.size.CropAndPad.__init__`.

    pad_cval : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
        See :func:`~augimg.augmenters.size.CropAndPad.__init__`.
...
class CenterPadToFixedSize(PadToFixedSize):
    ...
    This is an alias for :class:`~augimg.augmenters.size.PadToFixedSize`
    with ``position="center"``. It spreads the pad amounts equally over
    all image sides, while :class:`~augimg.augmenters.size.PadToFixedSize`
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.size.PadToFixedSize`.
...
# TODO this is very similar to CropAndPad, maybe add a way to generate crop
#      values imagewise via a callback in in CropAndPad?
# TODO add crop() function in augimg, similar to pad
...
class CenterCropToFixedSize(CropToFixedSize):
    ...
    This is an alias for :class:`~augimg.augmenters.size.CropToFixedSize` with
    ``position="center"``.
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.size.CropToFixedSize`.
...
class CenterCropToMultiplesOf(CropToMultiplesOf):
    ...
    This is the same as :class:`~augimg.augmenters.size.CropToMultiplesOf`,
    but uses ``position="center"`` by default, which spreads the crop amounts
    equally over all image sides, while
    :class:`~augimg.augmenters.size.CropToMultiplesOf` by default spreads
    them randomly.
...
class PadToMultiplesOf(PadToFixedSize):
    ...
    **Supported dtypes**:
    ...
    pad_mode : augimg.ALL or str or list of str or augimg.parameters.StochasticParameter, optional
        See :func:`~augimg.augmenters.size.PadToFixedSize.__init__`.
...
class CenterPadToMultiplesOf(PadToMultiplesOf):
    ...
    This is the same as :class:`~augimg.augmenters.size.PadToMultiplesOf`, but
    uses ``position="center"`` by default, which spreads the pad amounts
    equally over all image sides, while
    :class:`~augimg.augmenters.size.PadToMultiplesOf` by default spreads them
    randomly.
    ...
    **Supported dtypes**:
    ...
    pad_mode : augimg.ALL or str or list of str or augimg.parameters.StochasticParameter, optional
        See :func:`~augimg.augmenters.size.PadToMultiplesOf.__init__`.
...
class CenterCropToPowersOf(CropToPowersOf):
    ...
    This is the same as :class:`~augimg.augmenters.size.CropToPowersOf`, but
    uses ``position="center"`` by default, which spreads the crop amounts
    equally over all image sides, while
    :class:`~augimg.augmenters.size.CropToPowersOf` by default spreads them
    randomly.
...
class CenterPadToPowersOf(PadToPowersOf):
    ...
    This is the same as :class:`~augimg.augmenters.size.PadToPowersOf`, but uses
    ``position="center"`` by default, which spreads the pad amounts equally
    over all image sides, while :class:`~augimg.augmenters.size.PadToPowersOf`
    ...
    **Supported dtypes**:
    ...
    pad_mode : augimg.ALL or str or list of str or augimg.parameters.StochasticParameter, optional
        See :func:`~augimg.augmenters.size.PadToPowersOf.__init__`.
...
class CenterCropToAspectRatio(CropToAspectRatio):
    ...
    This is the same as :class:`~augimg.augmenters.size.CropToAspectRatio`, but
    uses ``position="center"`` by default, which spreads the crop amounts
    equally over all image sides, while
    :class:`~augimg.augmenters.size.CropToAspectRatio` by default spreads
    them randomly.
...
class CenterPadToAspectRatio(PadToAspectRatio):
    ...
    This is the same as :class:`~augimg.augmenters.size.PadToAspectRatio`, but
    uses ``position="center"`` by default, which spreads the pad amounts
    equally over all image sides, while
    :class:`~augimg.augmenters.size.PadToAspectRatio` by default spreads them
    randomly.
    ...
    **Supported dtypes**:
    ...
    pad_mode : augimg.ALL or str or list of str or augimg.parameters.StochasticParameter, optional
        See :func:`~augimg.augmenters.size.PadToAspectRatio.__init__`.
...
class CropToSquare(CropToAspectRatio):
    ...
    This is identical to :class:`~augimg.augmenters.size.CropToAspectRatio`
...
class CenterCropToSquare(CropToSquare):
    ...
    In contrast to :class:`~augimg.augmenters.size.CropToSquare`, this
    augmenter always tries to spread the columns/rows to remove equally over
    both sides of the respective axis to be cropped.
    :class:`~augimg.augmenters.size.CropToAspectRatio` by default spreads the
    croppings randomly.

    This augmenter is identical to :class:`~augimg.augmenters.size.CropToSquare`
    with ``position="center"``, and thereby the same as
    :class:`~augimg.augmenters.size.CropToAspectRatio` with
...
class PadToSquare(PadToAspectRatio):
    ...
    :class:`~augimg.augmenters.size.PadToAspectRatio` with ``aspect_ratio=1.0``.
...
class CenterPadToSquare(PadToSquare):
    ...
    This is the same as :class:`~augimg.augmenters.size.PadToSquare`, but uses
    ``position="center"`` by default, which spreads the pad amounts equally
    over all image sides, while :class:`~augimg.augmenters.size.PadToSquare`
    by default spreads them randomly. This augmenter is thus also identical to
    :class:`~augimg.augmenters.size.PadToAspectRatio` with
    ``aspect_ratio=1.0, position="center"``.
...
class KeepSizeByResize(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    children : Augmenter or list of augimg.augmenters.meta.Augmenter or None, optional
    ...
    interpolation : KeepSizeByResize.NO_RESIZE or {'nearest', 'linear', 'area', 'cubic'} or {cv2.INTER_NEAREST, cv2.INTER_LINEAR, cv2.INTER_AREA, cv2.INTER_CUBIC} or list of str or list of int or StochasticParameter, optional
        ...
        Can take any value that :func:`~augimg.augimg.imresize_single_image`
        accepts, e.g. ``cubic``.
