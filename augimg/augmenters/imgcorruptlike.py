...
_MISSING_PACKAGE_ERROR_MSG = (
    ...
    "dependency of augimg and must be installed manually in order "
    "to use augmenters from `augimg.augmenters.imgcorrupt`. "
...
def apply_gaussian_noise(x, severity=1, seed=None):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike._call_imgcorrupt_func`.
...
# (3) tools like pylint can't detect and validate it, (4) the augimg-doc
...
#     **Supported dtypes**:
#
#     See :func:`~augimg.augmenters.imgcorruptlike.apply_%s`.
#
#     Parameters
#     ----------
#     severity : int, optional
...
class GaussianNoise(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_gaussian_noise`.
...
class ShotNoise(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_shot_noise`.
...
class ImpulseNoise(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_impulse_noise`.
...
class SpeckleNoise(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_speckle_noise`.
...
class GaussianBlur(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_gaussian_blur`.
...
class GlassBlur(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_glass_blur`.
...
class DefocusBlur(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_defocus_blur`.
...
class MotionBlur(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_motion_blur`.
...
class ZoomBlur(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_zoom_blur`.
...
class Fog(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_fog`.
...
class Frost(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_frost`.
...
class Snow(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_snow`.
...
class Spatter(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_spatter`.
...
class Contrast(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_contrast`.
...
class Brightness(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_brightness`.
...
class Saturate(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_saturate`.
...
class JpegCompression(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_jpeg_compression`.
...
class Pixelate(_ImgcorruptAugmenterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_pixelate`.
...
class ElasticTransform(_ImgcorruptAugmenterBase):
    ...
    .. warning::
        ...
        Use :class:`~augimg.augmenters.geometric.ElasticTransformation` if
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.imgcorruptlike.apply_elastic_transform`.
    ...
    def _augment_batch_(self, batch, random_state, parents, hooks):
        ...
        assert len(cols) == 0 or (len(cols) == 1 and "images" in cols), (
            ...
            "augimg.augmenters.geometric.ElasticTransformation for "
