...
def stylize_cartoon(image, blur_ksize=3, segmentation_size=1.0,
    ...
    **Supported dtypes**:
    ...
    from_colorspace : str, optional
        The source colorspace. Use one of ``augimg.augmenters.color.CSPACE_*``.
        Defaults to ``RGB``.
...
class Cartoon(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.artistic.stylize_cartoon`.

    Parameters
    ----------
    blur_ksize : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
        Median filter kernel size.
        See :func:`~augimg.augmenters.artistic.stylize_cartoon` for details.
    ...
    segmentation_size : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
    ...
    saturation : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
    ...
    edge_prevalence : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
