...
class GammaContrast(_ContrastFuncWrapper):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.contrast.adjust_contrast_gamma`.

    Parameters
    ----------
    gamma : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
        Exponent for the contrast adjustment. Higher values darken the image.
...
class SigmoidContrast(_ContrastFuncWrapper):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.contrast.adjust_contrast_sigmoid`.

    Parameters
    ----------
    gain : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
        Multiplier for the sigmoid function's output.
        Higher values lead to quicker changes from dark to light pixels.
    ...
    cutoff : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
        Cutoff that shifts the sigmoid function in horizontal direction.
        Higher values mean that the switch from dark to light pixels happens
        later, i.e. the pixels will remain darker.
...
class LogContrast(_ContrastFuncWrapper):
    ...
    ``augimg.augmenters.arithmetic.Multiply``.

    **Supported dtypes**:

    See :func:`~augimg.augmenters.contrast.adjust_contrast_log`.
...
class LinearContrast(_ContrastFuncWrapper):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.contrast.adjust_contrast_linear`.
...
class AllChannelsCLAHE(meta.Augmenter):
    ...
    In contrast to ``augimg.augmenters.contrast.CLAHE``, this augmenter
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    clip_limit : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
        See ``augimg.augmenters.contrast.CLAHE``.

    tile_grid_size_px : int or tuple of int or list of int or augimg.parameters.StochasticParameter or tuple of tuple of int or tuple of list of int or tuple of augimg.parameters.StochasticParameter, optional
        See ``augimg.augmenters.contrast.CLAHE``.
...
class CLAHE(meta.Augmenter):
    ...
    ``augimg.augmenters.contrast.AllChannelsCLAHE`` instead.
    ...
    **Supported dtypes**:
        ...
        * ``bool``: no (1)
        ...
        - (1) This augmenter uses
              :class:`~augimg.augmenters.color.ChangeColorspace`, which is
    ...
    from_colorspace : {"RGB", "BGR", "HSV", "HLS", "Lab"}, optional
        ...
        See also :func:`~augimg.augmenters.color.change_colorspace_` for
        details.
    ...
    to_colorspace : {"Lab", "HLS", "HSV"}, optional
        ...
        see ``augimg.augmenters.contrast.AllChannelsCLAHE``.
...
class AllChannelsHistogramEqualization(meta.Augmenter):
    ...
    In contrast to ``augimg.augmenters.contrast.HistogramEqualization``, this
...
class HistogramEqualization(meta.Augmenter):
    ...
    This augmenter is similar to ``augimg.augmenters.contrast.CLAHE``.
    ...
    ``augimg.augmenters.contrast.AllChannelsHistogramEqualization`` instead.
    ...
    **Supported dtypes**:
    ...
    to_colorspace : {"Lab", "HLS", "HSV"}, optional
        ...
        ``augimg.augmenters.contrast.AllChannelsHistogramEqualization``.
