...
class AveragePooling(_AbstractPoolingBase):
    ...
    *without* striding, while ``AveragePooling`` applies striding corresponding
    ...
    .. note::
        ...
        are updated. This is because augimg can handle maps/maks that are
        larger/smaller than their corresponding image.

    **Supported dtypes**:

    See :func:`~augimg.augimg.avg_pool`.

    Attributes
    ----------
    kernel_size : int or tuple of int or list of int or augimg.parameters.StochasticParameter or tuple of tuple of int or tuple of list of int or tuple of augimg.parameters.StochasticParameter, optional
...
class MaxPooling(_AbstractPoolingBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augimg.max_pool`.
...
class MinPooling(_AbstractPoolingBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augimg.min_pool`.
...
class MedianPooling(_AbstractPoolingBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augimg.median_pool`.
