...
class RandAugment(meta.Sequential):
    ...
    **Supported dtypes**:
    ...
    minimum of (
        :class:`~augimg.augmenters.flip.Fliplr`,
        :class:`~augimg.augmenters.size.KeepSizeByResize`,
        :class:`~augimg.augmenters.size.Crop`,
        :class:`~augimg.augmenters.meta.Sequential`,
        :class:`~augimg.augmenters.meta.SomeOf`,
        :class:`~augimg.augmenters.meta.Identity`,
        :class:`~augimg.augmenters.pillike.Autocontrast`,
        :class:`~augimg.augmenters.pillike.Equalize`,
        :class:`~augimg.augmenters.arithmetic.Invert`,
        :class:`~augimg.augmenters.pillike.Affine`,
        :class:`~augimg.augmenters.pillike.Posterize`,
        :class:`~augimg.augmenters.pillike.Solarize`,
        :class:`~augimg.augmenters.pillike.EnhanceColor`,
        :class:`~augimg.augmenters.pillike.EnhanceContrast`,
        :class:`~augimg.augmenters.pillike.EnhanceBrightness`,
        :class:`~augimg.augmenters.pillike.EnhanceSharpness`,
        :class:`~augimg.augmenters.arithmetic.Cutout`,
        :class:`~augimg.augmenters.pillike.FilterBlur`,
        :class:`~augimg.augmenters.pillike.FilterSmooth`
    )
    ...
    n : int or tuple of int or list of int or augimg.parameters.StochasticParameter or None, optional
        ...
        See also parameter ``n`` in :class:`~augimg.augmenters.meta.SomeOf`
        for more details.
    ...
    m : int or tuple of int or list of int or augimg.parameters.StochasticParameter or None, optional
    ...
    cval : number or tuple of number or list of number or augimg.ALL or augimg.parameters.StochasticParameter, optional
        ...
        :class:`~augimg.augmenters.pillike.Affine` for details.
