...
class GaussianBlur(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See ``~augimg.augmenters.blur.blur_gaussian_(backend="auto")``.
...
class AverageBlur(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    k : int or tuple of int or tuple of tuple of int or augimg.parameters.StochasticParameter or tuple of StochasticParameter, optional
        Kernel size to use.
...
class MedianBlur(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    k : int or tuple of int or list of int or augimg.parameters.StochasticParameter, optional
        Kernel size.
...
class BilateralBlur(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    d : int or tuple of int or list of int or augimg.parameters.StochasticParameter, optional
    ...
    sigma_color : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
    ...
    sigma_space : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
...
class MotionBlur(iaa_convolutional.Convolve):
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.convolutional.Convolve`.
    ...
    angle : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
    ...
    direction : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
...
class MeanShiftBlur(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.blur.blur_mean_shift_`.

    Parameters
    ----------
    spatial_radius : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
        Spatial radius for pixels that are assumed to be similar.
    ...
    color_radius : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
        Color radius for pixels that are assumed to be similar.
