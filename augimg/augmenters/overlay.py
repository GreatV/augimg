...
@ia.deprecated(alt_func="augimg.augmenters.blend.blend_alpha()",
               comment=_DEPRECATION_COMMENT)
def blend_alpha(*args, **kwargs):
    """See :func:`~augimg.augmenters.blend.blend_alpha`."""
    # pylint: disable=invalid-name
    return blend.blend_alpha(*args, **kwargs)


@ia.deprecated(alt_func="augimg.augmenters.blend.BlendAlpha",
               comment=_DEPRECATION_COMMENT)
def Alpha(*args, **kwargs):
    """See :class:`~augimg.augmenters.blend.BlendAlpha`."""
    # pylint: disable=invalid-name
    return blend.Alpha(*args, **kwargs)


@ia.deprecated(alt_func="augimg.augmenters.blend.BlendAlphaElementwise",
               comment=_DEPRECATION_COMMENT)
...
@ia.deprecated(alt_func="augimg.augmenters.blend.BlendAlphaSimplexNoise",
               comment=_DEPRECATION_COMMENT)
def SimplexNoiseAlpha(*args, **kwargs):
    """See :class:`~augimg.augmenters.blend.BlendAlphaSimplexNoise`."""
    # pylint: disable=invalid-name
    return blend.SimplexNoiseAlpha(*args, **kwargs)


@ia.deprecated(alt_func="augimg.augmenters.blend.BlendAlphaFrequencyNoise",
               comment=_DEPRECATION_COMMENT)
def FrequencyNoiseAlpha(*args, **kwargs):
    """See :class:`~augimg.augmenters.blend.BlendAlphaFrequencyNoise`."""
    # pylint: disable=invalid-name
