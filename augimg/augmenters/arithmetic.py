...
from ..augimg import _normalize_cv2_input_arr_
...
_CUTOUT_FILL_MODES = {
    "constant": ("augimg.augmenters.arithmetic", "_fill_rectangle_constant_"),
    "gaussian": ("augimg.augmenters.arithmetic", "_fill_rectangle_gaussian_")
}
...
def cutout(image, x1, y1, x2, y2,
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.arithmetic.cutout_`.
...
def cutout_(image, x1, y1, x2, y2,
    ...
    **Supported dtypes**:
    ...
    minimum of (
        :func:`~augimg.augmenters.arithmetic._fill_rectangle_gaussian_`,
        :func:`~augimg.augmenters.arithmetic._fill_rectangle_constant_`
    )
    ...
    seed : None or int or augimg.random.RNG or numpy.random.Generator or numpy.random.BitGenerator or numpy.random.SeedSequence or numpy.random.RandomState, optional
        ...
        See :class:`augimg.random.RNG` for details.
    ...
    **Supported dtypes**:
        ...
        * ``bool``: yes; tested
        ...
        - (1) ``uint64`` is currently not supported, because
              :func:`~augimg.dtypes.clip_to_dtype_value_range_()` does not
...
def invert(image, min_value=None, max_value=None, threshold=None,
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.arithmetic.invert_`.
...
def solarize(image, threshold=128):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.arithmetic.solarize_`.
...
def solarize_(image, threshold=128):
    ...
    **Supported dtypes**:
    ...
    See ``~augimg.augmenters.arithmetic.invert_(min_value=None and max_value=None)``.
...
class Add(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.arithmetic.add_scalar`.

    Parameters
    ----------
    value : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
...
class AddElementwise(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.arithmetic.add_elementwise`.

    Parameters
    ----------
    value : int or tuple of int or list of int or augimg.parameters.StochasticParameter, optional
...
class AdditiveGaussianNoise(AddElementwise):
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.arithmetic.AddElementwise`.

    Parameters
    ----------
    loc : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
...
class AdditivePoissonNoise(AddElementwise):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    lam : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
...
class Multiply(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.arithmetic.multiply_scalar`.

    Parameters
    ----------
    mul : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
...
class MultiplyElementwise(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.arithmetic.multiply_elementwise`.
...
class Cutout(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    nb_iterations : int or tuple of int or list of int or augimg.parameters.StochasticParameter, optional
    ...
    position : {'uniform', 'normal', 'center', 'left-top', 'left-center', 'left-bottom', 'center-top', 'center-center', 'center-bottom', 'right-top', 'right-center', 'right-bottom'} or tuple of float or StochasticParameter or tuple of StochasticParameter, optional
        ...
        :class:`~augimg.augmenters.size.CropToFixedSize`.
        Usually, ``uniform`` (anywhere in the image) or ``normal`` (anywhere
        in the image with preference around the center) are sane values.

    size : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
    ...
    squared : bool or float or augimg.parameters.StochasticParameter, optional
    ...
    fill_mode : str or list of str or augimg.parameters.StochasticParameter, optional
    ...
    cval : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
    ...
    fill_per_channel : bool or float or augimg.parameters.StochasticParameter, optional
    ...
    random_state : None or int or augimg.random.RNG or numpy.random.Generator or numpy.random.bit_generator.BitGenerator or numpy.random.SeedSequence or numpy.random.RandomState, optional
        See :func:`~augimg.augmenters.meta.Augmenter.__init__`.
...
class Dropout(MultiplyElementwise):
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.arithmetic.MultiplyElementwise`.

    Parameters
    ----------
    p : float or tuple of float or augimg.parameters.StochasticParameter, optional
        The probability of any pixel being dropped (i.e. to set it to zero).
            ...
            * If a ``StochasticParameter``, then this parameter will be used to
              ...
              parameter, you can usually do ``augimg.parameters.Binomial(1-p)``
...
class CoarseDropout(MultiplyElementwise):
    ...
    **Supported dtypes**:
    ...
    size_px : None or int or tuple of int or augimg.parameters.StochasticParameter, optional
    ...
    size_percent : None or float or tuple of float or augimg.parameters.StochasticParameter, optional
        The size of the lower resolution image from which to sample the dropout
...
class ReplaceElementwise(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.arithmetic.replace_elementwise_`.

    Parameters
    ----------
    mask : float or tuple of float or list of float or augimg.parameters.StochasticParameter
    ...
    replacement : number or tuple of number or list of number or augimg.parameters.StochasticParameter
    ...
    >>> import augimg.augmenters as iaa
    >>> import augimg.parameters as iap
...
class SaltAndPepper(ReplaceElementwise):
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.arithmetic.ReplaceElementwise`.

    Parameters
    ----------
    p : float or tuple of float or list of float or augimg.parameters.StochasticParameter, optional
...
class ImpulseNoise(SaltAndPepper):
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.arithmetic.SaltAndPepper`.
...
class CoarseSaltAndPepper(ReplaceElementwise):
    ...
    **Supported dtypes**:
    ...
    size_px : int or tuple of int or augimg.parameters.StochasticParameter, optional
    ...
    size_percent : float or tuple of float or augimg.parameters.StochasticParameter, optional
        The size of the lower resolution image from which to sample the
...
class Invert(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    threshold : None or number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
        A threshold to use in order to invert only numbers above or below
        the threshold. If ``None`` no thresholding will be used.
    ...
    invert_above_threshold : bool or float or augimg.parameters.StochasticParameter, optional
        If ``True``, only values ``>=threshold`` will be inverted.
        Otherwise, only values ``<threshold`` will be inverted.
...
class Solarize(Invert):
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.arithmetic.Invert`.

    Parameters
    ----------
    p : float or augimg.parameters.StochasticParameter
        See :class:`Invert`.
...
@ia.deprecated("augimg.contrast.LinearContrast")
def ContrastNormalization(alpha=1.0, per_channel=False,
    ...
    dtype support:
        ...
        See ``augimg.augmenters.contrast.LinearContrast``.
...
class JpegCompression(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.arithmetic.compress_jpeg`.

    Parameters
    ----------
    compression : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
