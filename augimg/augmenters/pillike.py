...
def equalize(image, mask=None):
    ...
    See :func:`~augimg.augmenters.pillike.equalize_` for details.
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.pillike.equalize_`.
...
def _apply_enhance_func(image, cls, factor):
    ...
    image, is_hw1 = _ensure_valid_shape(
        image, "augimg.augmenters.pillike.enhance_*()")
...
def _filter_by_kernel(image, kernel):
    ...
    image, is_hw1 = _ensure_valid_shape(
        image, "augimg.augmenters.pillike.filter_*()")
...
def warp_affine(image,
    ...
    **Supported dtypes**:
    ...
    image, is_hw1 = _ensure_valid_shape(
        image, "augimg.augmenters.pillike.warp_affine()")
...
class Posterize(colorlib.Posterize):
    ...
    :class:`~augimg.augmenters.color.Posterize`, which again is an alias
    for :class:`~augimg.augmenters.color.UniformColorQuantizationToNBits`,
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.color.Posterize`.
...
class Autocontrast(contrastlib._ContrastFuncWrapper):
    ...
    See :func:`~augimg.augmenters.pillike.autocontrast` for more details.

    Added in 0.4.0.

    **Supported dtypes**:

    See :func:`~augimg.augmenters.pillike.autocontrast`.

    Parameters
    ----------
    cutoff : int or tuple of int or list of int or augimg.parameters.StochasticParameter, optional
...
class EnhanceColor(_EnhanceBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.pillike.enhance_color`.
...
class EnhanceContrast(_EnhanceBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.pillike.enhance_contrast`.
...
class EnhanceBrightness(_EnhanceBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.pillike.enhance_brightness`.
...
class EnhanceSharpness(_EnhanceBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.pillike.enhance_sharpness`.
...
class FilterBlur(_FilterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.pillike.filter_blur`.
...
class FilterSmooth(_FilterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.pillike.filter_smooth`.
...
class FilterSmoothMore(_FilterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.pillike.filter_smooth_more`.
...
class FilterEdgeEnhance(_FilterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.pillike.filter_edge_enhance`.
...
class FilterEdgeEnhanceMore(_FilterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.pillike.filter_edge_enhance_more`.
...
class FilterFindEdges(_FilterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.pillike.filter_find_edges`.
...
class FilterContour(_FilterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.pillike.filter_contour`.
...
class FilterEmboss(_FilterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.pillike.filter_emboss`.
...
class FilterSharpen(_FilterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.pillike.filter_sharpen`.
...
class FilterDetail(_FilterBase):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.pillike.filter_detail`.
...
class Affine(geometric.Affine):
    ...
    .. warning::
        ...
        Use :class:`~augimg.augmenters.geometric.Affine` if you have to
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.pillike.warp_affine`.
    ...
    fillcolor : number or tuple of number or list of number or augimg.ALL or augimg.parameters.StochasticParameter, optional
        See parameter ``cval`` in :class:`~augimg.augmenters.geometric.Affine`.
    ...
    center : {'uniform', 'normal', 'center', 'left-top', 'left-center', 'left-bottom', 'center-top', 'center-center', 'center-bottom', 'right-top', 'right-center', 'right-bottom'} or tuple of float or StochasticParameter or tuple of StochasticParameter, optional
        ...
        :class:`~augimg.augmenters.size.PadToFixedSize` for details
    ...
    See the similar augmenter :class:`~augimg.augmenters.geometric.Affine`
    for more examples.
    ...
    def _augment_batch_(self, batch, random_state, parents, hooks):
        ...
        assert len(cols) == 0 or (len(cols) == 1 and "images" in cols), (
            ...
            "batch containing: %s. Use augimg.augmenters.geometric.Affine for "
