...
def change_colorspace_(image, to_colorspace, from_colorspace=CSPACE_RGB):
    ...
    **Supported dtypes**:
    ...
    to_colorspace : str
        ...
        e.g. ``augimg.augmenters.color.CSPACE_RGB``.
...
def change_colorspaces_(images, to_colorspaces, from_colorspaces=CSPACE_RGB):
    ...
    **Supported dtypes**:
    ...
    to_colorspaces : str or iterable of str
        ...
        ``augimg.augmenters.color.CSPACE_RGB``.
...
def change_color_temperatures_(images, kelvins, from_colorspaces=CSPACE_RGB):
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.color.change_colorspace_`.
...
def change_color_temperature(image, kelvin, from_colorspace=CSPACE_RGB):
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.color.change_color_temperatures_`.
...
class WithBrightnessChannels(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    to_colorspace : augimg.ALL or str or list of str or augimg.parameters.StochasticParameter, optional
        Colorspace in which to extract the brightness-related channels.
        Currently, ``augimg.augmenters.color.CSPACE_YCrCb``, ``CSPACE_HSV``,
        ``CSPACE_HLS``, ``CSPACE_Lab``, ``CSPACE_Luv``, ``CSPACE_YUV``,
        ``CSPACE_CIE`` are supported.

            * If ``augimg.ALL``: Will pick imagewise a random colorspace from
              all supported colorspaces.
            * If ``str``: Will always use this colorspace.
            * If ``list`` or ``str``: Will pick imagewise a random colorspace
              from this list.
            * If :class:`~augimg.parameters.StochasticParameter`:
...
class MultiplyAndAddToBrightness(WithBrightnessChannels):
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.color.WithBrightnessChannels`.

    Parameters
    ----------
    mul : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
        See :class:`~augimg.augmenters.airthmetic.Multiply`.

    add : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
        See :class:`~augimg.augmenters.airthmetic.Add`.
...
class MultiplyBrightness(MultiplyAndAddToBrightness):
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.color.MultiplyAndAddToBrightness`.
...
class MultiplyHueAndSaturation(WithHueAndSaturation):
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.color.WithHueAndSaturation`.

    Parameters
    ----------
    mul : None or number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
    ...
    mul_hue : None or number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
    ...
    mul_saturation : None or number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
...
class MultiplyHue(MultiplyHueAndSaturation):
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.color.MultiplyHueAndSaturation`.
...
class RemoveSaturation(MultiplySaturation):
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.color.MultiplySaturation`.
...
def AddToHueAndSaturation(value=0, per_channel=False, from_colorspace="RGB",
    ...
    value : int or tuple of int or list of int or augimg.parameters.StochasticParameter, optional
        See :func:`~augimg.augmenters.arithmetic.Add.__init__()`.
    ...
    channels : int or list of int or None, optional
        See :func:`~augimg.augmenters.meta.WithChannels.__init__()`.
...
class AddToHueAndSaturation(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    value : None or int or tuple of int or list of int or augimg.parameters.StochasticParameter, optional
    ...
    value_hue : None or int or tuple of int or list of int or augimg.parameters.StochasticParameter, optional
    ...
    value_saturation : None or int or tuple of int or list of int or augimg.parameters.StochasticParameter, optional
...
class AddToHue(AddToHueAndSaturation):
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.color.AddToHueAndSaturation`.
...
class ChangeColorspace(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    to_colorspace : str or list of str or augimg.parameters.StochasticParameter
        The target colorspace.
        Allowed strings are: ``RGB``, ``BGR``, ``GRAY``, ``CIE``, ``YCrCb``,
        ``HSV``, ``HLS``, ``Lab``, ``Luv``.
        These are also accessible via
        ``augimg.augmenters.color.CSPACE_<NAME>``,
        e.g. ``augimg.augmenters.CSPACE_YCrCb``.
...
class ChangeColorTemperature(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.color.change_color_temperatures_`.

    Parameters
    ----------
    kelvin : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
...
class KMeansColorQuantization(_AbstractColorQuantization):
    ...
    **Supported dtypes**:
    ...
    if (image size <= max_size):
        ...
        minimum of (
            :class:`~augimg.augmenters.color.ChangeColorspace`,
            :func:`~augimg.augmenters.color.quantize_kmeans`
        )
    ...
    if (image size > max_size):
        ...
        minimum of (
            :class:`~augimg.augmenters.color.ChangeColorspace`,
            :func:`~augimg.augmenters.color.quantize_kmeans`,
            :func:`~augimg.augimg.imresize_single_image`
        )

    Parameters
    ----------
    n_colors : int or tuple of int or list of int or augimg.parameters.StochasticParameter, optional
    ...
    to_colorspace : None or str or list of str or augimg.parameters.StochasticParameter
        The colorspace in which to perform the quantization.
        See :func:`~augimg.augmenters.color.change_colorspace_` for valid values.
...
@ia.deprecated("augimg.augmenters.colors.quantize_kmeans")
...
def quantize_kmeans(arr, nb_clusters, nb_max_iter=10, eps=1.0):
    ...
    .. warning::
        ...
        internal RNG and augimg's global RNG. This is necessary in order
...
class UniformColorQuantization(_AbstractColorQuantization):
    ...
    **Supported dtypes**:
    ...
    if (image size <= max_size):
        ...
        minimum of (
            :class:`~augimg.augmenters.color.ChangeColorspace`,
            :func:`~augimg.augmenters.color.quantize_uniform_`
        )
...
class UniformColorQuantizationToNBits(_AbstractColorQuantization):
    ...
    **Supported dtypes**:
    ...
    if (image size <= max_size):
        ...
        minimum of (
            :class:`~augimg.augmenters.color.ChangeColorspace`,
            :func:`~augimg.augmenters.color.quantize_uniform`
        )
    ...
    Parameters
    ----------
    nb_bits : int or tuple of int or list of int or augimg.parameters.StochasticParameter, optional
...
class Posterize(UniformColorQuantizationToNBits):
    ...
    **Supported dtypes**:
    ...
    See :class:`~augimg.augmenters.color.UniformColorQuantizationToNBits`.

    """


@ia.deprecated("augimg.augmenters.colors.quantize_uniform")
...
def quantize_uniform(arr, nb_bins, to_bin_centers=True):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.color.quantize_uniform_`.
...
def quantize_uniform_to_n_bits(arr, nb_bits):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.color.quantize_uniform_to_n_bits_`.
...
def posterize(arr, nb_bits):
    ...
    **Supported dtypes**:
    ...
    See :func:`~augimg.augmenters.color.quantize_uniform_to_n_bits`.
