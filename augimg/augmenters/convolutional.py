...
def convolve(image, kernel):
    ...
    **Supported dtypes**:
        ...
        See :func:`~augimg.augmenters.convolutional.convolve_`.
...
class Convolve(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    Parameters
    ----------
    matrix : None or (H, W) ndarray or augimg.parameters.StochasticParameter or callable, optional
...
class Sharpen(Convolve):
    ...
    **Supported dtypes**:
    ...
    lightness : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
...
class Emboss(Convolve):
    ...
    **Supported dtypes**:
    ...
    strength : number or tuple of number or list of number or augimg.parameters.StochasticParameter, optional
