...
:class:`~augimg.augmenters.convolutional.EdgeDetect` and
:class:`~augimg.augmenters.convolutional.DirectedEdgeDetect` are currently
...
class RandomColorsBinaryImageColorizer(IBinaryImageColorizer):
    ...
    Parameters
    ----------
    color_true : int or tuple of int or list of int or augimg.parameters.StochasticParameter, optional
    ...
    color_false : int or tuple of int or list of int or augimg.parameters.StochasticParameter, optional
...
class Canny(meta.Augmenter):
    ...
    **Supported dtypes**:
    ...
    hysteresis_thresholds : number or tuple of number or list of number or augimg.parameters.StochasticParameter or tuple of tuple of number or tuple of list of number or tuple of augimg.parameters.StochasticParameter, optional
    ...
    sobel_kernel_size : int or tuple of int or list of int or augimg.parameters.StochasticParameter, optional
    ...
    colorizer : None or augimg.augmenters.edges.IBinaryImageColorizer, optional
