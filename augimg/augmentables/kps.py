...
class Keypoint(object):
    ...
    def project_(self, from_shape, to_shape):
        ...
        Returns
        -------
        augimg.augmentables.kps.Keypoint
    ...
    def generate_similar_points_manhattan(self, nb_steps, step_size,
        ...
        Returns
        -------
        list of augimg.augmentables.kps.Keypoint or (N,2) ndarray
    ...
    def coords_almost_equals(self, other, max_distance=1e-4):
        ...
        Parameters
        ----------
        other : augimg.augmentables.kps.Keypoint or iterable
    ...
    def almost_equals(self, other, max_distance=1e-4):
        ...
        max_distance : number, optional
            See
            :func:`~augimg.augmentables.kps.Keypoint.coords_almost_equals`.
...
class KeypointsOnImage(IAugmentable):
    ...
    Parameters
    ----------
    keypoints : list of augimg.augmentables.kps.Keypoint
    ...
    def copy(self, keypoints=None, shape=None):
        ...
        Parameters
        ----------
        keypoints : None or list of augimg.Keypoint, optional
            List of keypoints on the image.
