...
def recover_psois_(psois, psois_orig, recoverer, random_state):
    ...
    Parameters
    ----------
    psois : list of augimg.augmentables.polys.PolygonsOnImage or augimg.augmentables.polys.PolygonsOnImage
        The possibly broken polygons, e.g. after augmentation.
        The `recoverer` is applied to them.

    psois_orig : list of augimg.augmentables.polys.PolygonsOnImage or augimg.augmentables.polys.PolygonsOnImage
        Original polygons that were later changed to `psois`.
        They are an extra input to `recoverer`.

    recoverer : augimg.augmentables.polys._ConcavePolygonRecoverer
...
class Polygon(object):
    ...
    Parameters
    ----------
    exterior : list of augimg.augmentables.kps.Keypoint or list of tuple of float or (N,2) ndarray
        List of points defining the polygon. May be either a ``list`` of
        :class:`~augimg.augmentables.kps.Keypoint` objects or a ``list`` of
    ...
    def clip_out_of_image(self, image):
        ...
        Returns
        -------
        list of augimg.augmentables.polys.Polygon
    ...
    def subdivide_(self, points_per_edge):
        ...
        See :func:`~augimg.augmentables.lines.LineString.subdivide` for details.
    ...
    def to_bounding_box(self):
        ...
        Returns
        -------
        augimg.augmentables.bbs.BoundingBox
    ...
    def to_keypoints(self):
        ...
        Returns
        -------
        list of augimg.augmentables.kps.Keypoint
            Exterior vertices as :class:`~augimg.augmentables.kps.Keypoint`
            instances.
    ...
    def to_line_string(self, closed=True):
        ...
        Returns
        -------
        augimg.augmentables.lines.LineString
    ...
    def coords_almost_equals(self, other, max_distance=1e-4,
        ...
        Parameters
        ----------
        other : augimg.augmentables.polys.Polygon or (N,2) ndarray or list of tuple
            See
            :func:`~augimg.augmentables.polys.Polygon.exterior_almost_equals`.
    ...
    def almost_equals(self, other, max_distance=1e-4, points_per_edge=8):
        ...
        This is the same as
        :func:`~augimg.augmentables.polys.Polygon.exterior_almost_equals` but
        additionally compares the labels.

        Parameters
        ----------
        other : augimg.augmentables.polys.Polygon
    ...
    def copy(self, exterior=None, label=None):
        ...
        Parameters
        ----------
        exterior : list of augimg.augmentables.kps.Keypoint or list of tuple or (N,2) ndarray, optional
            List of points defining the polygon. See
            :func:`~augimg.augmentables.polys.Polygon.__init__` for details.
    ...
    def deepcopy(self, exterior=None, label=None):
        ...
        exterior : list of Keypoint or list of tuple or (N,2) ndarray, optional
            List of points defining the polygon. See
            `augimg.augmentables.polys.Polygon.__init__` for details.
...
class PolygonsOnImage(IAugmentable):
    ...
    Parameters
    ----------
    polygons : list of augimg.augmentables.polys.Polygon
    ...
    def to_keypoints_on_image(self):
        ...
        Returns
        -------
        augimg.augmentables.kps.KeypointsOnImage
    ...
    def invert_to_keypoints_on_image_(self, kpsoi):
        ...
        Parameters
        ----------
        kpsoi : augimg.augmentables.kps.KeypointsOnImages
    ...
    def copy(self, polygons=None, shape=None):
        ...
        Parameters
        ----------
        polygons : None or list of augimg.augmentables.polys.Polygons, optional
            List of polygons on the image.
...
class _ConcavePolygonRecoverer(object):
    ...
    def _generate_intersection_points(self, exterior,
        ...
        from augimg.external.poly_point_isect_py2py3 import (
...
class MultiPolygon(object):
    ...
    Parameters
    ----------
    geoms : list of augimg.augmentables.polys.Polygon
    ...
    def from_shapely(geometry, label=None):
        ...
        Returns
        -------
        augimg.augmentables.polys.MultiPolygon
