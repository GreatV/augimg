...
class LineString(object):
    ...
    def compute_pointwise_distances(self, other, default=None):
        ...
        Parameters
        ----------
        other : tuple of number or augimg.augmentables.kps.Keypoint or augimg.augmentables.LineString
    ...
    def contains(self, other, max_distance=1e-4):
        ...
        Parameters
        ----------
        other : tuple of number or augimg.augmentables.kps.Keypoint
            Point to check for.
    ...
    def clip_out_of_image(self, image):
        ...
        Returns
        -------
        list of augimg.augmentables.lines.LineString
    ...
    def shift_(self, x=0, y=0):
        ...
        Returns
        -------
        result : augimg.augmentables.lines.LineString
            Shifted line string.
            The object may have been modified in-place.
    ...
    def concatenate(self, other):
        ...
        Parameters
        ----------
        other : augimg.augmentables.lines.LineString or ndarray or iterable of tuple of number
    ...
    def to_bounding_box(self):
        ...
        Returns
        -------
        None or augimg.augmentables.bbs.BoundingBox
    ...
    def to_heatmap(self, image_shape, size_lines=1, size_points=0,
        ...
        This is similar to
        :func:`~augimg.augmentables.lines.LineString.draw_lines_heatmap_array`,
        executed with ``alpha=1.0``. The result is wrapped in a
        :class:`~augimg.augmentables.heatmaps.HeatmapsOnImage` object instead
        ...
        Returns
        -------
        augimg.augmentables.heatmaps.HeatmapsOnImage
    ...
    def to_segmentation_map(self, image_shape, size_lines=1, size_points=0,
        ...
        This is similar to
        :func:`~augimg.augmentables.lines.LineString.draw_mask`.
        ...
        Returns
        -------
        augimg.augmentables.segmaps.SegmentationMapsOnImage
    ...
    def coords_almost_equals(self, other, max_distance=1e-4, points_per_edge=8):
        ...
        Parameters
        ----------
        other : augimg.augmentables.lines.LineString or tuple of number or ndarray or list of ndarray or list of tuple of number
    ...
    def almost_equals(self, other, max_distance=1e-4, points_per_edge=8):
        ...
        Parameters
        ----------
        other: augimg.augmentables.lines.LineString
            The other object to compare against. Expected to be a
            ``LineString``.

        max_distance : float, optional
            See :func:`~augimg.augmentables.lines.LineString.coords_almost_equals`.
...
class LineStringsOnImage(IAugmentable):
    ...
    Parameters
    ----------
    line_strings : list of augimg.augmentables.lines.LineString
    ...
    def on_(self, image):
        ...
        Returns
        -------
        augimg.augmentables.lines.LineStrings
    ...
    def from_xy_arrays(cls, xy, shape):
        ...
        :func:`~augimg.augmentables.lines.LineStringsOnImage.to_xy_array`.
        ...
        Returns
        -------
        augimg.augmentables.lines.LineStringsOnImage
    ...
    def to_xy_arrays(self, dtype=np.float32):
        ...
        This is the inverse of
        :func:`~augimg.augmentables.lines.LineStringsOnImage.from_xy_array`.
    ...
    def copy(self, line_strings=None, shape=None):
        ...
        Parameters
        ----------
        line_strings : None or list of augimg.augmentables.lines.LineString, optional
            List of line strings on the image.
