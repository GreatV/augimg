...
class UnnormalizedBatch(object):
    ...
    heatmaps : None or (N,H,W,C) ndarray or augimg.augmentables.heatmaps.HeatmapsOnImage or iterable of (H,W,C) ndarray or iterable of augimg.augmentables.heatmaps.HeatmapsOnImage
    ...
    segmentation_maps : None or (N,H,W) ndarray or augimg.augmentables.segmaps.SegmentationMapsOnImage or iterable of (H,W) ndarray or iterable of augimg.augmentables.segmaps.SegmentationMapsOnImage
    ...
    keypoints : None or list of (N,K,2) ndarray or tuple of number or augimg.augmentables.kps.Keypoint or iterable of (K,2) ndarray or iterable of tuple of number or iterable of augimg.augmentables.kps.Keypoint or iterable of augimg.augmentables.kps.KeypointOnImage or iterable of iterable of tuple of number or iterable of iterable of augimg.augmentables.kps.Keypoint
    ...
    bounding_boxes : None or (N,B,4) ndarray or tuple of number or augimg.augmentables.bbs.BoundingBox or augimg.augmentables.bbs.BoundingBoxesOnImage or iterable of (B,4) ndarray or iterable of tuple of number or iterable of augimg.augmentables.bbs.BoundingBox or iterable of augimg.augmentables.bbs.BoundingBoxesOnImage or iterable of iterable of tuple of number or iterable of iterable augimg.augmentables.bbs.BoundingBox
    ...
    polygons : None  or (N,#polys,#points,2) ndarray or augimg.augmentables.polys.Polygon or augimg.augmentables.polys.PolygonsOnImage or iterable of (#polys,#points,2) ndarray or iterable of tuple of number or iterable of augimg.augmentables.kps.Keypoint or iterable of augimg.augmentables.polys.Polygon or iterable of augimg.augmentables.polys.PolygonsOnImage or iterable of iterable of (#points,2) ndarray or iterable of iterable of tuple of number or iterable of iterable of augimg.augmentables.kps.Keypoint or iterable of iterable of augimg.augmentables.polys.Polygon or iterable of iterable of iterable of tuple of number or iterable of iterable of iterable of tuple of augimg.augmentables.kps.Keypoint
    ...
    line_strings : None or (N,#lines,#points,2) ndarray or augimg.augmentables.lines.LineString or augimg.augmentables.lines.LineStringOnImage or iterable of (#lines,#points,2) ndarray or iterable of tuple of number or iterable of augimg.augmentables.kps.Keypoint or iterable of augimg.augmentables.lines.LineString or iterable of augimg.augmentables.lines.LineStringOnImage or iterable of iterable of (#points,2) ndarray or iterable of iterable of tuple of number or iterable of iterable of augimg.augmentables.kps.Keypoint or iterable of iterable of augimg.augmentables.polys.LineString or iterable of iterable of iterable of tuple of number or iterable of iterable of iterable of tuple of augimg.augmentables.kps.Keypoint
    ...
    def fill_from_augmented_normalized_batch_(self, batch_aug_norm):
        ...
        Parameters
        ----------
        batch_aug_norm: augimg.augmentables.batches.Batch
...
class Batch(object):
    ...
    heatmaps : None or list of augimg.augmentables.heatmaps.HeatmapsOnImage
        The heatmaps to augment.

    segmentation_maps : None or list of augimg.augmentables.segmaps.SegmentationMapsOnImage
        The segmentation maps to augment.

    keypoints : None or list of augimg.augmentables.kps.KeypointOnImage
        The keypoints to augment.

    bounding_boxes : None or list of augimg.augmentables.bbs.BoundingBoxesOnImage
        The bounding boxes to augment.

    polygons : None or list of augimg.augmentables.polys.PolygonsOnImage
        The polygons to augment.

    line_strings : None or list of augimg.augmentables.lines.LineStringsOnImage
        The line strings to augment.
    ...
    def deepcopy(self,
        ...
        Parameters
        ----------
        images_unaug : augimg.augmentables.batches.DEFAULT or None or (N,H,W,C) ndarray or list of (H,W,C) ndarray
            Copies the current attribute value without changes if set to
            ``augimg.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        images_aug : augimg.augmentables.batches.DEFAULT or None or (N,H,W,C) ndarray or list of (H,W,C) ndarray
            Copies the current attribute value without changes if set to
            ``augimg.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        heatmaps_unaug : augimg.augmentables.batches.DEFAULT or None or list of augimg.augmentables.heatmaps.HeatmapsOnImage
            Copies the current attribute value without changes if set to
            ``augimg.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        heatmaps_aug : augimg.augmentables.batches.DEFAULT or None or list of augimg.augmentables.heatmaps.HeatmapsOnImage
            Copies the current attribute value without changes if set to
            ``augimg.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        segmentation_maps_unaug : augimg.augmentables.batches.DEFAULT or None or list of augimg.augmentables.segmaps.SegmentationMapsOnImage
            Copies the current attribute value without changes if set to
            ``augimg.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        segmentation_maps_aug : augimg.augmentables.batches.DEFAULT or None or list of augimg.augmentables.segmaps.SegmentationMapsOnImage
            Copies the current attribute value without changes if set to
            ``augimg.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        keypoints_unaug : augimg.augmentables.batches.DEFAULT or None or list of augimg.augmentables.kps.KeypointOnImage
            Copies the current attribute value without changes if set to
            ``augimg.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        keypoints_aug : augimg.augmentables.batches.DEFAULT or None or list of augimg.augmentables.kps.KeypointOnImage
            Copies the current attribute value without changes if set to
            ``augimg.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        bounding_boxes_unaug : augimg.augmentables.batches.DEFAULT or None or list of augimg.augmentables.bbs.BoundingBoxesOnImage
            Copies the current attribute value without changes if set to
            ``augimg.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        bounding_boxes_aug : augimg.augmentables.batches.DEFAULT or None or list of augimg.augmentables.bbs.BoundingBoxesOnImage
            Copies the current attribute value without changes if set to
            ``augimg.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        polygons_unaug : augimg.augmentables.batches.DEFAULT or None or list of augimg.augmentables.polys.PolygonsOnImage
            Copies the current attribute value without changes if set to
            ``augimg.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        polygons_aug : augimg.augmentables.batches.DEFAULT or None or list of augimg.augmentables.polys.PolygonsOnImage
            Copies the current attribute value without changes if set to
            ``augimg.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        line_strings_unaug : augimg.augmentables.batches.DEFAULT or None or list of augimg.augmentables.lines.LineStringsOnImage
            Copies the current attribute value without changes if set to
            ``augimg.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.

        line_strings_aug : augimg.augmentables.batches.DEFAULT or None or list of augimg.augmentables.lines.LineStringsOnImage
            Copies the current attribute value without changes if set to
            ``augimg.augmentables.batches.DEFAULT``.
            Otherwise same as in :func:`Batch.__init__`.
...
class _BatchInAugmentation(object):
    ...
    def propagation_hooks_ctx(self, augmenter, hooks, parents):
        ...
        hooks : augimg.augimg.HooksImages or augimg.augimg.HooksKeypoints
    ...
    def to_batch(self, batch_before_aug):
        ...
        Parameters
        ----------
        batch_before_aug : augimg.augmentables.batches.Batch
