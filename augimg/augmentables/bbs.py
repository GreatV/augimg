...
class BoundingBox(object):
    ...
    def intersection(self, other, default=None):
        ...
        Parameters
        ----------
        other : augimg.augmentables.bbs.BoundingBox
        ...
        Returns
        -------
        augimg.augmentables.bbs.BoundingBox or any
    ...
    def draw_on_image(self, image, color=(0, 255, 0), alpha=1.0, size=1,
        ...
        :func:`~augimg.augmentables.bbs.BoundingBox.draw_box_on_image`.
        To draw the label even if it is ``None`` or to configure e.g. its
        color, use
        :func:`~augimg.augmentables.bbs.BoundingBox.draw_label_on_image`.
    ...
    def to_polygon(self):
        ...
        """
        # TODO get rid of this deferred import
        from augimg.augmentables.polys import Polygon
    ...
    def coords_almost_equals(self, other, max_distance=1e-4):
        ...
        Parameters
        ----------
        other : augimg.augmentables.bbs.BoundingBox or iterable
    ...
    def almost_equals(self, other, max_distance=1e-4):
        ...
        This is the same as
        :func:`~augimg.augmentables.bbs.BoundingBox.coords_almost_equals` but
        ...
        max_distance : number, optional
            See
            :func:`~augimg.augmentables.bbs.BoundingBox.coords_almost_equals`.
    ...
    def from_point_soup(cls, xy):
        ...
        :func:`~augimg.BoundingBoxesOnImage.to_xyxy_array`.
...
class BoundingBoxesOnImage(IAugmentable):
    ...
    Parameters
    ----------
    bounding_boxes : list of augimg.augmentables.bbs.BoundingBox
    ...
    --------
    >>> import numpy as np
    >>> from augimg.augmentables.bbs import BoundingBox, BoundingBoxesOnImage
    >>>
    ...
    def on_(self, image):
        ...
        Returns
        -------
        augimg.augmentables.bbs.BoundingBoxesOnImage
    ...
    def to_xyxy_array(self, dtype=np.float32):
        ...
        This is the inverse of
        :func:`~augimg.BoundingBoxesOnImage.from_xyxy_array`.
    ...
    def fill_from_xy_array_(self, xy):
        ...
        See
        :func:`~augimg.augmentables.bbs.BoundingBoxesOnImage.fill_from_xyxy_array_`.
    ...
    def copy(self, bounding_boxes=None, shape=None):
        ...
        Parameters
        ----------
        bounding_boxes : None or list of augimg.augmntables.bbs.BoundingBox, optional
            List of bounding boxes on the image.
    ...
    def __getitem__(self, indices):
        ...
        Returns
        -------
        list of augimg.augmentables.bbs.BoundingBoxes
