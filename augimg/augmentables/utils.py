...
def convert_cbaois_to_kpsois(cbaois):
    ...
    Parameters
    ----------
    cbaois : list of augimg.augmentables.bbs.BoundingBoxesOnImage or list of augimg.augmentables.bbs.PolygonsOnImage or list of augimg.augmentables.bbs.LineStringsOnImage or augimg.augmentables.bbs.BoundingBoxesOnImage or augimg.augmentables.bbs.PolygonsOnImage or augimg.augmentables.bbs.LineStringsOnImage
        Coordinate-based augmentables to convert, e.g. bounding boxes.

    Returns
    -------
    list of augimg.augmentables.kps.KeypointsOnImage or augimg.augmentables.kps.KeypointsOnImage
...
def invert_convert_cbaois_to_kpsois_(cbaois, kpsois):
    ...
    kpsois : list of augimg.augmentables.kps.KeypointsOnImages or augimg.augmentables.kps.KeypointsOnImages
        Keypoints to convert back to the types of `cbaois`, i.e. the outputs
        of :func:`convert_cbaois_to_kpsois`.

    Returns
    -------
    list of augimg.augmentables.bbs.BoundingBoxesOnImage or list of augimg.augmentables.bbs.PolygonsOnImage or list of augimg.augmentables.bbs.LineStringsOnImage or augimg.augmentables.bbs.BoundingBoxesOnImage or augimg.augmentables.bbs.PolygonsOnImage or augimg.augmentables.bbs.LineStringsOnImage
