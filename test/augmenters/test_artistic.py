...
import augimg.augmenters.artistic as artisticlib
...
class Test_stylize_cartoon(unittest.TestCase):
    ...
    @mock.patch("augimg.augmenters.artistic._suppress_edge_blobs")
    ...
    @mock.patch("augimg.augmenters.artistic._find_edges_laplacian")
...
class TestCartoon(unittest.TestCase):
    ...
    @mock.patch("augimg.augmenters.artistic.stylize_cartoon")
